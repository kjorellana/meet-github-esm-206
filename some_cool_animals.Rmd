...
![Ringtail cat (Courtesy of Virginia Zoo)](img/ringtail_cat.jpg)
We'll also learn about `knitr::include_graphics()`

Add a few fun facts: 

- They can rotate their hind feet 180 degrees which makes the awesome at climbing. 
- They are not an endangered species but are very elusive.
